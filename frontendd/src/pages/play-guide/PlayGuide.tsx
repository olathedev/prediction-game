    ...
    <div className="w-full h-full container mx-auto">
      ...
      <div className="flex space-x-6 mt-8">
        {cardContents.map((content, index) => (
          <div key={index} className="bg-white/60 backdrop-blur-md  flex flex-col items-center gap-4 w-1/3 rounded-3xl p-4">
            <h2 className="text-center text-4xl text-[#2463FF]">0{index+1}</h2>
