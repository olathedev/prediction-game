...
const Game = () => {
  ...
  const question =
    "Two high-performance race cars are lined up at the starting line, ready to battle it out on a fast-paced, high-stakes track. Car A and Car B, which do you think would win";
